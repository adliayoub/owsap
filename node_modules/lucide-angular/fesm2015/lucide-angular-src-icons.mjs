...
const Gift = [
    ...
    [
        ...
        [
            'path',
            { d: 'M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z', key: 'zighg4' },
        ],
        [
            'path',
            { d: 'M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z', key: '1pa5tk' },
        ],
    ],
];
...
class LucideAngularComponent {
    ...
    replaceElement(img) {
        var _a;
        const attributes = Object.assign(Object.assign(Object.assign({}, defaultAttributes), img[1]), { width: typeof this.size === 'number'
                ? this.size.toString(10)
                : this.size, height: typeof this.size === 'number'
                ? this.size.toString(10)
                : this.size, stroke: (_a = this.color) !== null && _a !== void 0 ? _a : this.iconConfig.color, 'stroke-width': this.absoluteStrokeWidth
    ...
    createElement([tag, attrs, children = []]) {
        ...
        Object.keys(attrs).forEach((name) => {
            const attrValue = typeof attrs[name] === 'string'
                ? attrs[name]
