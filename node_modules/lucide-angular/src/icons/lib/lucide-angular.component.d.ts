import { ChangeDetectorRef, Renderer2, ElementRef, OnChanges, SimpleChange } from '@angular/core';
...
export declare class LucideAngularComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<LucideAngularComponent, "lucide-angular, lucide-icon, i-lucide, span-lucide", never, { "class": "class"; "name": "name"; "img": "img"; "color": "color"; "size": "size"; "strokeWidth": "strokeWidth"; "absoluteStrokeWidth": "absoluteStrokeWidth"; }, {}, never, ["*"]>;
}
export {};
